...
1. 48 registered mebers of S-1088. 41 with ORCIDs. After cleaning, **22 members** were searchable.

2. 1,476 "works" were identified. After de-duplication (966), and restricting to only works of type `article`, resulted in **740 publications.**

3. Common research concepts across these articles include XXX, and common funders include YYY.   

4. *How do the themes connected to S-1088 activities compare with the broader research landscape?*

5. *Which agencies and programs are supporting work in these areas?*
