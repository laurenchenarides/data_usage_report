...
4.  **Institution recognition:** Determining how each platform records institutional information
...
**Need to add content from Rafael**
...
|:---------------------------------|:------|
| ARMS                                            | 1,581 |
| Census of Agriculture                           | 5,834 |
| Food Access Research Atlas                      | 590  |
| Food Acquisition and Purchase Survey            | 807  |
| Household Food Security Survey Module           | 1,406 |
| Rural-Urban Continuum Code                      | 3,022 |

: Unique Publications with Metadata across Sources {#tbl-pub-counts}

All code used to clean, deduplicate, and merge records is provided in [this Appendix. **UPDATE LINK**](https://laurenchenarides.github.io/compare_scopus_openalex_report/appendix.html)
...
![](graphics/dot_plots/dataset01_journals_scopusonly_dot.png)

\newpage

![](graphics/dot_plots/dataset01_journals_openalexonly_dot.png)
:::
