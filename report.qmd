...
<figure style="text-align: center;">
  <a href="graphics/ARMS_treemap.png" target="_blank">
    <img src="graphics/ARMS_treemap.png" style="width:80%; height:auto;" alt="ARMS Treemap">
  </a>
</figure>
:::

::: {.content-visible when-format="pdf"}
![](graphics/ARMS_treemap.png)
:::
...
::: {.content-visible when-format="html"}
<figure style="text-align: center;">
  <a href="graphics/Census_of_Agriculture_treemap.png" target="_blank">
    <img src="graphics/Census_of_Agriculture_treemap.png" style="width:80%; height:auto;" alt="Ag Census Treemap">
  </a>
</figure>
:::

::: {.content-visible when-format="pdf"}
![](graphics/Census_of_Agriculture_treemap.png)
:::
...
::: {.content-visible when-format="html"}
<figure style="text-align: center;">
  <a href="graphics/Food_Access_Research_Atlas_treemap.png" target="_blank">
    <img src="graphics/Food_Access_Research_Atlas_treemap.png" style="width:80%; height:auto;" alt="ARMS Treemap">
  </a>
</figure>
:::

::: {.content-visible when-format="pdf"}
![](graphics/Food_Access_Research_Atlas_treemap.png)
:::
