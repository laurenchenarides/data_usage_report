...
format:
  ...
  pdf:
    ...
    latex-engine: pdflatex  # or xelatex if you need nicer fonts
---
...
Filtering was further refined by selecting publications associated with high-relevance topics (Table \@ref(tab:top25topics) lists the top 25 topics), top publishing journals (Table \@ref(tab:top25journals) lists the top 25 journals), and U.S.-affiliated authors (Table \@ref(tab:top25authors) lists the top 25 authors). 
...
Table: (\#tab:top25topics) Top 25 Topics by First Run Count
...
Table: (\#tab:top25journals) Top 25 Journals by First Run Count
...
Table: (\#tab:top25authors) Top 25 Authors by First Run Count
...
# \Large Results Comparing Publication and Journal Coverage
...
## \Large Method 1 (Full Text Search)
...
## \Large Method 2 (Seed Corpus Approach)
...
# \Large Results Comparing Publication Coverage Disaggregated by Journal
