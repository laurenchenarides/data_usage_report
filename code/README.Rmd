...
#### Step 4: Merge all entities

**Script name:** `13_build_all_df.R`

Merges author-, institution-, and publication-level metadata into a final consolidated table.

**Output:**

- `all_df`: a harmonized dataframe with DOIs, authors, affiliations, and source-level indicators
...
Available at: [https://laurenchenarides.github.io/compare_scopus_openalex_report/report.html](https://laurenchenarides.github.io/compare_scopus_openalex_report/report.html)
