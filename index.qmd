...
Citation databases form the foundation of modern research tracking and analysis. Digital repositories, like Scopus and OpenAlex, systematically catalog scholarly publications and their references to each other (De Bellis 2009). Citation databases differ in their approaches to curating and maintaining this information. Some focus exclusively on peer-reviewed journal articles with strict inclusion criteria, while others index a broader range of research outputs including preprints, technical reports, and conference proceedings (Martin-Martin et al. 2021, Mongeon & Paul-Hus 2016). These curation approaches affect how comprehensively each database captures research impact (Visser, et al. 2021).
